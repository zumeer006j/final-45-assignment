//More Conditional Tests: You don’t have to limist the number of tests you create to 10. If you want to try more comparisons, write more tests. Have at least one True and one False result for each of the following:
//• Tests for equality with string
console.log("equality test with string : ", "orange" === "orange");
// .Tests for inequality with string
console.log("inequality test with string : ", "orange" !== "apple");
...
console.log("equality test with string : ", 34 !== 35);
...
console.log("test watermelon is not the array :", !fruits.includes("watermelon"));
